  ...
  return (
    <section className="relative w-full pb-20 bg-[rgb(243,232,226)] ">
      <div className="max-w-6xl mx-auto flex px-5  pt-28 pb-5 justify-between items-center ">
        <h2 className="text-primary text-start text-3xl lg:text-4xl w-60 md:w-[25rem] border font-bold font-kufam">
          ...
          <div key={review.id} className="flex-shrink-0 max-w-[380px]">
            <div className="flex flex-col  justify-center p-4 ">
              ...
              <div className="flex items-center gap-4">
                <div className="w-14 h-14  overflow-hidden border-4 border-[#F4DACD] rounded-full">
                  <img
                    src={review.image}
                    alt={review.author}
