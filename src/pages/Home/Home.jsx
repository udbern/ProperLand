        ...
        <div className="max-w-[609px] w-full mx-auto mt-32 lg:ml-24">
          <div className="p-1 mb-5 bg-gradient-to-r w-fit px-5 to-[#FFB28D] from-[#F3D1C1]">
            <div className="flex items-center space-x-4">
              <img src={House} alt="tiny-house" className="w-6 h-6 object-contain" />
              <span className="font-kufam text-base sm:text-lg md:text-xl font-normal">Real Estate Agency</span>
            </div>
          </div>
          <div className="text-center lg:text-left">
            ...
            >
              Explore Property <IoArrowForwardCircleSharp className="ml-2 text-secondary h-4 w-4" />
            </button>
          </div>
        </div>
      </div>
